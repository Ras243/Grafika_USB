...
void display() {
    ...
    int flagWidth = 600;  // Adjust this according to your flag's width
    int flagHeight = 400; // Adjust this according to your flag's height
    ...
    // Draw the blue rectangle on top
    ...
    // Draw the red rectangle on the bottom
